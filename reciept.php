...
$db = mysqli_select_db($con, "cinema_db.sql");
						...
						<tr>
							<td class="title">
								<div class="footer-brand">
									<h1 class="footer-heading">ColdStar Cinemas</h1>
								</div>
							</td>
							<td>
	...
	<div style="max-width: 300px; margin:auto; padding: 30px;">
		...
		<a type="button" class="btn btn-success" href='http://localhost/www/index.php'>Home-Page</a>
	</div>
