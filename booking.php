            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="13-3">January 13,2021</option>
                        <option value="14-3">January 14,2021</option>
                        <option value="15-3">January 15,2021</option>
                        <option value="16-3">January 16,2021</option>
                    </select>
